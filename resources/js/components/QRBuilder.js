                    ...
                    <div className="card bg-secondary shadow">
                        <div className="card-header bg-white border-0">
                            <div className="row align-items-center">
                                <div className="col-8">
                                    <h3 className="mb-0">Restaurant QR Generator</h3>
                                </div>
                            </div>
                        </div>

                        <div className="card-body">
                            <h6 className="heading-small text-muted mb-4">Select QR Style</h6>
                            ...
                            <h6 className="heading-small text-muted mb-4">Select QR color</h6>
                            <br />
                ...
                <div className="col-xl-4">
                    ...
                    <div className="card bg-secondary shadow">
                            <div className="card-header bg-white border-0">
                                <div className="row align-items-center">
                                    <div className="col-8">
                                        <h3 className="mb-0">QR Dowloader</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <br />
                            <button  onClick={()=>{this.downloadJPEG().then(res => this.setImgData(res))}} type="button" className="btn btn-success">Download JPG</button>
                            { /* <button  onClick={()=>{this.downloadSVG()}} type="button" className="btn btn-primary">Download SVG</button> */ }
                            <br /><br /><br /><br />
                            </div>
                ...
                <div className="col-xl-4">
                    ...
                    <div className="card bg-secondary shadow">
                            <div className="card-header bg-white border-0">
                                <div className="row align-items-center">
                                    <div className="col-8">
                                        <h3 className="mb-0">Menu Print template</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                                ...
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img className="d-block w-100" src="/impactfront/img/menu_template_1.jpg" />
                                    </div>
                                    <div className="carousel-item">
                                        <img className="d-block w-100" src="/impactfront/img/menu_template_2.jpg" />
                                    </div>
                                </div>
                                ...
                                <br />
                                <a  href="/impactfront/img/templates.zip" target="_blank" type="button" className="btn btn-success">Download print templates</a> 
                            </div>
